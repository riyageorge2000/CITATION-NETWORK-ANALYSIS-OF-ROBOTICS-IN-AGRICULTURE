...
# Convert the frequency table to a pandas DataFrame
df = pd.DataFrame.from_dict(frequency_table, orient='index')
...
plt.title(f"Top {num_most_common} Most Frequent Words Across Documents")
plt.xlabel("Words")
...
# Save the frequency table to an Excel sheet
output_excel = "frequency_table.xlsx"
df.to_excel(output_excel, sheet_name='Frequency Table', index=True)
